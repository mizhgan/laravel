...
L.AwesomeMarkers.Icon = L.Icon.extend({
  ...
  _createInner: function() {
    ...
    + (this.options.iconColor ? " icon-" + this.options.iconColor :"") + "'></span>" + (this.options.text ? "<p style='font-size: 8px; "+ (this.options.iconColor ? "color: " + this.options.iconColor :"") + "'>" + this.options.text + "</p>" : "");
  },
