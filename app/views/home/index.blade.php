  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Здравствуйте!
        Вы находитесь на сайте, где собирается, систематизируется и визуализируется информация о покрытии нашего города (Кирово-Чепецк, если кто забыл) беспроводными сетями. В частности - сетями WiFi, и, немножко, GSM. Главная страница сайта представляет из себя карту, на которую нанесены условные обозначения (маркеры). Давайте с ними разберемся:
